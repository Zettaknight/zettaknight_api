...
urlpatterns = patterns('',
    ...
    url(r'^zettaknight/user/check_quota/(?P<username>.+)/$', views.zettaknightshareview.as_view()),
    #url(r'^zettaknight/user/check_quota/', views.zettaknightshareview.as_view()),
    ...
    #url(r'^zettaknight/group/usage/', views.zettaknightusageview.as_view())
)
